...
<f:view>
  <html>
    ...
    <h1>New Usuarios</h1>
    <h:form>
      <h:inputHidden id="validateCreateField" validator="#{usuarios.validateCreate}" value="value"/>
      <h:panelGrid columns="2">
        <h:outputText value="Id:"/>
        <h:inputText id="id" value="#{usuarios.usuarios.id}" title="Id" required="true" requiredMessage="The id field is required." />
      ...
      <br />
      <h:commandLink action="#{usuarios.create}" value="Create"/>
      <br />
      <br />
