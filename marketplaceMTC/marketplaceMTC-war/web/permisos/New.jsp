...
<f:view>
  <html>
    ...
    <h1>New Permisos</h1>
    <h:form>
      <h:inputHidden id="validateCreateField" validator="#{permisos.validateCreate}" value="value"/>
      ...
      <br />
      <h:commandLink action="#{permisos.create}" value="Create"/>
      <br />
      <br />
