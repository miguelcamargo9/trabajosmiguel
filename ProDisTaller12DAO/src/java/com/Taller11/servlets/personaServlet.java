...
public class personaServlet extends HttpServlet {
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.println("</th>");
      out.println("<th>Documento");
      out.println("</th>");
      out.println("</tr>");
      for (persona miPersona : misPersonas) {
        out.println("<tr>");
        out.println("<td>"+miPersona.getNombre());
        out.println("</td>");
        out.println("<td>"+miPersona.getApellido());
        out.println("</td>");
        out.println("<td>"+miPersona.getDocumento());
        out.println("</td>");
        out.println("</tr>");
      }
      out.println("</table>");
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      misPersonas = miDao.traerPersonas();
      bandera = true;
    } catch (Exception ex) {
      bandera = false;
